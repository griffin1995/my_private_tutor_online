			...
			<div className='max-w-7xl mx-auto space-y-12'>
				...
				<section className='space-y-4'>
					...
					<div className='flex gap-4 p-4 bg-gray-50 rounded-lg'>
						<span className='text-token-primary font-semibold'>
							text-token-primary
						</span>
						<span className='text-token-primary-light font-semibold'>
							text-token-primary-light
						</span>
						<span className='text-token-primary-dark font-semibold'>
							text-token-primary-dark
						</span>
						<span className='text-token-primary-muted font-semibold'>
							text-token-primary-muted
						</span>
					</div>
					{}
				...
				<section className='space-y-4'>
					...
					<div className='flex gap-4 p-4 bg-gray-50 rounded-lg'>
						...
						<span className='text-token-secondary-light font-semibold'>
							text-token-secondary-light
						</span>
						<span className='text-token-secondary-dark font-semibold'>
							text-token-secondary-dark
						</span>
						<span className='text-token-secondary-muted font-semibold'>
							text-token-secondary-muted
						</span>
					</div>
					{}
					<div className='flex gap-4'>
				...
				<section className='space-y-4'>
					...
					<div className='flex gap-4'>
						<div className='p-4 bg-token-neutral-800 rounded-lg'>
							<span className='text-token-neutral-white'>
								text-token-neutral-white on dark
							</span>
						</div>
						<div className='p-4 bg-token-neutral-black rounded-lg'>
							<span className='text-token-neutral-50'>
								text-token-neutral-50 on black
							</span>
						</div>
					</div>
				</section>
				...
				<section className='space-y-4'>
					...
					{}
					<div className='flex gap-4'>
						<span className='text-token-semantic-success font-semibold'>
							Success text
						</span>
						<span className='text-token-semantic-error font-semibold'>
							Error text
						</span>
						<span className='text-token-semantic-warning font-semibold'>
							Warning text
						</span>
