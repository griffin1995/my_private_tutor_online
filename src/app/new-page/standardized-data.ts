// CONTEXT7 SOURCE: /microsoft/typescript - Standardized data structure implementation
// DATA ORGANIZATION REASON: Official TypeScript documentation for data modeling and type safety

import { type StandardizedContent, type StandardizedVideoMasterclass, createHeadingTextSection, createVideoGridSection } from './types';

// Standardized video data with consistent field structure
...
// Export standardized section data
export const standardizedPageContent: readonly StandardizedContent[] = [
  ...
  createVideoGridSection("primary-school-videos-1", primarySchoolVideos, "py-16"),
  createVideoGridSection("primary-school-videos-2", primarySchoolIndividualVideos, "py-16"),
  ...
  createVideoGridSection("secondary-school-videos-1", secondarySchoolVideos1, "py-16"),
  createVideoGridSection("secondary-school-videos-2", secondarySchoolVideos2, "py-16"),
];

// Utility function to get standardized content by ID
export function getStandardizedContentById(id: string): StandardizedContent | undefined {
  return standardizedPageContent.find(section => section.id === id);
}

// Utility function to get all heading sections
export function getAllHeadingSections(): StandardizedHeadingContent[] {
  return standardizedPageContent.filter(section => section.sectionType === 'heading-text') as StandardizedHeadingContent[];
}

// Utility function to get all video sections
export function getAllVideoSections(): StandardizedVideoContent[] {
  return standardizedPageContent.filter(section => section.sectionType === 'video-grid') as StandardizedVideoContent[];
}