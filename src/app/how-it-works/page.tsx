...
export default function HowItWorksPage() {
  ...
  return (
    <PageLayout background="white">
      ...
      {/* 
       * Documentation Source: Context7 MCP - Component Preservation Strategy
       * Reference: /context7/react_dev - Component extraction for safe storage
       * Pattern: Original homepage How It Works section preserved at bottom of page
       * 
       * Purpose:
       * - Safely stores original homepage implementation
       * - Allows client review during site development
       * - Can be easily restored or moved if needed
       * - Maintains separation from main page content
       * 
       * Implementation:
       * - HomepageHowItWorks component with modified subtitle
       * - Clearly labeled as "Old Homepage Implementation"
       * - Separated visually from main page content
       * - Uses different background color for distinction
       */}
      <HomepageHowItWorks 
        title="How It Works"
