        ...
        <div className="relative max-w-4xl mx-auto text-center z-20 bg-transparent px-6 sm:px-8 md:px-12 lg:px-16 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          >
            ...
            <p className="text-white text-sm text-center mb-8">
              Trusted by elite families • Featured in Tatler Address Book 2025 •
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-lg text-primary-700 mb-6 leading-relaxed">
                    As the founder of My Private Tutor Online, Elizabeth
                    personally oversees every aspect of our process. With over
                    15 years of experience and a deep understanding of both
                    British and international education systems, she ensures
                    that each family receives the exceptional service they
                    deserve.
                  </p>

                  <p className="text-lg text-primary-700 mb-8 leading-relaxed">
                    Having moved through six different schools herself,
                    Elizabeth understands the challenges families face when
                    navigating educational transitions. Her expertise in
                    Oxbridge admissions and royal client service standards means
                    your family receives the same level of care as our most
                  ...
                  <div className="bg-amber-50 p-6 rounded-2xl border-l-4 border-amber-500">
                    ...
                    <p className="text-primary-700 italic">
                      "Every family deserves personalised attention and
                      exceptional results. That's why I'm personally involved in
                      every consultation and tutor pairing, ensuring the perfect
                      match for your child's unique needs and aspirations."
                    </p>
