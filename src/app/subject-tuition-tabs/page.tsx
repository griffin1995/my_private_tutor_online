...
const educationLevels = [
  {
    ...
    description: "The primary curriculum is the scaffolding upon which secondary success plays out; we're passionate about plugging gaps and getting it right.",
    subjects: ["Mathematics", "English", "Science", "Reading & Comprehension", "Writing Skills"],
    keyFeatures: [
  ...
  },
  {
    ...
    description: "One-to-one tutoring for KS3, GCSE, A-Level and IB, delivered by experienced subject specialists and examiners.",
    subjects: ["Mathematics", "English Literature & Language", "Sciences", "History", "Geography", "Modern Foreign Languages"],
    keyFeatures: [
  ...
  },
  {
    ...
    subjects: ["Mathematics", "English Language & Literature", "Biology", "Chemistry", "Physics", "History", "Geography", "Modern Languages"],
    keyFeatures: [
  ...
  // A-Level removed for 1-to-1 content mapping with /new-page accordion sections
  {
    ...
    description: "Expert academic support for undergraduates and postgraduates, including essay coaching, dissertations, and subject-specific tutoring.",
    subjects: ["Essay Writing", "Research Methods", "Statistics", "Subject-Specific Support", "Dissertation Guidance"],
    keyFeatures: [
  ...
  },
  {
    ...
    subjects: ["Professional Qualifications", "Career Development", "Digital Literacy", "Language Learning", "Creative Writing"],
    keyFeatures: [
  ...
  },
  {
    ...
    description: "Our Founder Elizabeth's own neurodiversity (dyspraxia) means she's especially passionate about equipping students with gamechanging SEN support.",
    subjects: ["Individualised Learning", "Strength Identification", "Learning Style Analysis", "Accessibility Support"],
    keyFeatures: [
  ...
  },
  {
    ...
    subjects: ["All Academic Subjects", "Interview Preparation", "Entrance Exams", "Study Skills"],
    keyFeatures: [
      "DBS-checked tutors",
...
export default function SubjectTuitionTabsPage({ className }: SubjectTuitionTabsProps) {
  ...
  const [selectedTab, setSelectedTab] = useState<EducationLevelValue>('primary-school')
    ...
    videos: [
      {
        ...
        bulletPoints: ["Age-appropriate teaching methods", "Confidence building activities", "Positive reinforcement techniques", "Play-based learning integration"],
        youtubeUrl: null,
        thumbnailImage: "/images/features/confidence-building-lessons-early-learners.jpg",
        backgroundImage: "/images/features/confidence-building-lessons-early-learners.jpg",
        isPaid: false,
      },
      {
        ...
        bulletPoints: ["Entrance exam expertise", "Grammar school preparation", "Preparatory school success", "Examination confidence building"],
        youtubeUrl: null,
        thumbnailImage: "/images/features/7-8-11-plus-specialists-track-record-top-school-offers.jpg",
        backgroundImage: "/images/features/7-8-11-plus-specialists-track-record-top-school-offers.jpg",
        isPaid: false,
      },
      {
        ...
        bulletPoints: ["Comprehensive initial assessment", "Personalised learning plans", "Regular progress monitoring", "Adaptive teaching methods"],
        youtubeUrl: null,
        thumbnailImage: "/images/features/individual-learning-plans-expert-assessment.jpg",
        backgroundImage: "/images/features/individual-learning-plans-expert-assessment.jpg",
        isPaid: false,
      }
    ]
  };
    ...
    videos: [
      {
        ...
        bulletPoints: ["GCSE & A-Level expertise", "University pathway planning", "Grade improvement strategies", "Profile strengthening"],
        youtubeUrl: null,
      ...
      },
      {
        ...
        bulletPoints: ["Individual assessment", "Learning style identification", "Progress monitoring", "Measurable outcomes"],
        youtubeUrl: null,
      ...
      },
      {
        ...
        bulletPoints: ["Mathematics & Further Mathematics", "Biology", "Chemistry", "Physics"],
        youtubeUrl: null,
...
const TabContent = memo(({ level, contentData }: { level: StrictEducationLevel, contentData: any }) => {
  return (
    <Tabs.Content
      key={level.value}
      value={level.value}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Our expert tutors provide specialised support across all educational stages,
              from primary school foundations to university-level excellence.
            </p>
          </div>
          ...
          >
            ...
            {/* CONTEXT7 SOURCE: /radix-ui/website - Container width consistency for tabs and content alignment */}
            {/* WIDTH ALIGNMENT REASON: Official Radix UI documentation for consistent container patterns between List and Content */}
            <div className="w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
              <Tabs.List
            ...
            {/* PRIMARY SCHOOL TAB - Exact accordion content */}
            <TabContent
                ...
                <motion.div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  <motion.div className="w-full">
                    <VideoMasterclassSectionImageFullWidthTextHalfWidth
                      video={convertToVideoMasterclass(primarySchoolData.videos[0])}
                      className="py-0"
                    />
                  </motion.div>
                  <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                    <motion.div>
                      <VideoMasterclassSectionTextFullWidth
                        video={convertToVideoMasterclass(primarySchoolData.videos[1])}
                        layout="text-left"
                        className="py-0"
                      />
                    </motion.div>
                    <motion.div>
                      <VideoMasterclassSectionTextFullWidth
                        video={convertToVideoMasterclass(primarySchoolData.videos[2])}
                        layout="text-right"
                        className="py-0"
                      />
                    </motion.div>
            ...
            {/* SECONDARY SCHOOL TAB - Exact accordion content */}
            <TabContent
              ...
              contentData={
                <div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  <div className="w-full">
                    <VideoMasterclassSectionImageFullWidthTextHalfWidth
                      video={convertToVideoMasterclass(secondarySchoolData.videos[1])}
                      className="py-0"
                    />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                    <div>
                      <VideoMasterclassSectionTextFullWidth
                        video={convertToVideoMasterclass(secondarySchoolData.videos[2])}
                        layout="text-left"
                        className="py-0"
                      />
                    </div>
                    <div>
                      <VideoMasterclassSectionTextFullWidth
                        video={convertToVideoMasterclass(secondarySchoolData.videos[0])}
                        layout="text-right"
                        className="py-0"
                      />
                    </div>
            ...
            {/* ENTRANCE EXAMS TAB - Exact Entrance Exams accordion content */}
            <TabContent
            ...
            {/* UNIVERSITY ADMISSIONS TAB - Exact University Admissions accordion content */}
            <TabContent
              level={educationLevels.find(l => l.value === "university-admissions")!}
              contentData={
                <div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  {universityAdmissionsData.videos.length > 0 && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                      {universityAdmissionsData.videos.slice(0, 2).map((video, index) => (
                        <div key={video.id}>
                          <VideoMasterclassSectionTextFullWidth
                            video={video}
            ...
            {/* ONLINE HOMESCHOOLING TAB - Exact Online Homeschooling accordion content */}
            <TabContent
              level={educationLevels.find(l => l.value === "online-homeschooling")!}
              contentData={
                <VideoMasterclassSectionImageFullWidthTextHalfWidth
                  video={onlineHomeschoolingData.video}
                  className="py-0"
                />
              }
            />

            {/* SEN SUPPORT TAB - Exact SEN Support accordion content */}
            <TabContent
            ...
            {/* LONDON IN-PERSON TAB - Exact London Tutoring accordion content */}
            <TabContent
...
export type { SubjectTuitionTabsProps, StrictEducationLevel, EducationLevelValue }