          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-8 max-w-3xl mx-auto">
                ...
                at top 10 UK schools and official examiners for GCSEs, A Levels
                and IB exams. Each tutor is an expert in their field and has
                hundreds, if not thousands, of hours teaching experience.
              </p>
            </div>
          </div>
        </section>
