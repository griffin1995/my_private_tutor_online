						...
						<div className='max-w-5xl mx-auto'>
							<m.div
								...
								<p className='text-blue-700'>
									This privacy policy complies with UK GDPR, Data Protection Act 2018,
							...
							<div className='prose prose-lg prose-slate max-w-none'>
								...
								<p>
									My Private Tutor Online Limited ("we", "us", "our") respects your
									privacy and is committed to protecting your personal data. This privacy
									policy explains how we look after your personal data when you visit our
										...
										<div className='flex items-start gap-4'>
											...
											<div>
												...
												<p className='text-amber-800 text-lg leading-relaxed'>
													Given our prestigious clientele, including members of distinguished
													families and high-profile individuals, we maintain the highest
													standards of confidentiality and data protection. All staff sign
													comprehensive non-disclosure agreements and undergo enhanced
													security vetting.
												</p>
											</div>
										</div>
								...
								<h2>2. Who We Are</h2>
								<p>
									My Private Tutor Online Limited is the data controller and is
									responsible for your personal data. We have been providing premium
									tutoring services since 2010 and are based in the United Kingdom.
								</p>
								...
								<div className='bg-gray-50 p-6 rounded-lg my-6'>
									...
									<ul className='space-y-1 text-sm'>
										<li>
											<strong>Company:</strong> My Private Tutor Online Limited
										</li>
										<li>
											<strong>Registration:</strong> Companies House [Registration Number]
										</li>
										<li>
										...
										<li>
											...
											privacy@myprivatetutoronline.co.uk
										</li>
										<li>
								...
								<ul>
									...
									<li>
										<strong>Educational Data:</strong> Current school, academic level,
										subjects studied, exam boards
									</li>
									<li>
										<strong>Assessment Data:</strong> Academic assessments, progress
										reports, learning needs
									</li>
									<li>
										<strong>Special Category Data:</strong> Learning difficulties,
										disabilities (with explicit consent)
									</li>
									<li>
										<strong>Financial Data:</strong> Payment method details, billing
										addresses
									</li>
								</ul>
								...
								<p>We may process special category personal data including:</p>
								<ul>
								...
								<p>
									We will only process this data with your explicit consent or where
									legally required.
								</p>
											...
											<div>
												...
												<ul className='text-green-800 space-y-3'>
													<li className='flex items-start gap-2'>
														...
														<span>
															<strong>Contract:</strong> To perform our tutoring services
														</span>
													</li>
													<li className='flex items-start gap-2'>
														<CheckCircle className='w-5 h-5 text-green-600 mt-0.5 flex-shrink-0' />
													...
													<li className='flex items-start gap-2'>
														<CheckCircle className='w-5 h-5 text-green-600 mt-0.5 flex-shrink-0' />
														<span>
															<strong>Consent:</strong> For special category data and marketing
															communications
														</span>
													</li>
													<li className='flex items-start gap-2'>
														<CheckCircle className='w-5 h-5 text-green-600 mt-0.5 flex-shrink-0' />
														<span>
															<strong>Legal obligation:</strong> For safeguarding and
								...
								<p>
									We share relevant student information with matched tutors to enable
									effective teaching. All tutors sign comprehensive confidentiality
									agreements and undergo enhanced background checks.
								</p>

								<h3>6.2 Service Providers</h3>
								<ul>
									<li>
										<strong>Video Conferencing:</strong> Zoom, Microsoft Teams (for online
										sessions)
									</li>
									<li>
										<strong>Payment Processing:</strong> Stripe, PayPal (for secure
										payments)
									</li>
									<li>
										<strong>Email Services:</strong> Mailchimp, SendGrid (for
										communications)
									</li>
									<li>
										<strong>Analytics:</strong> Google Analytics, Hotjar (for website
										improvement)
									</li>
									<li>
										<strong>Customer Support:</strong> Zendesk, Intercom (for support
										services)
									</li>
								</ul>

								<h3>6.3 Legal Requirements</h3>
								<p>We may share your data where required by law, including:</p>
								<ul>
								...
								<m.div
									...
									<Card className='p-8 my-12 bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-200 shadow-xl rounded-2xl'>
										<div className='flex items-start gap-4'>
											...
											<div>
												<h3 className='text-2xl font-serif font-bold text-purple-800 mb-4'>
													Cross-Border Data Protection
												</h3>
												<p className='text-purple-800 text-lg leading-relaxed'>
													We serve clients internationally and may transfer data outside the
													UK/EEA. All transfers are protected by appropriate safeguards
								...
								<p>
									When we transfer your data outside the UK/EEA, we ensure appropriate
								...
								<div className='bg-gray-50 p-6 rounded-lg my-6'>
									...
									<ul className='space-y-2 text-sm'>
										<li>
											<strong>Student Records:</strong> 7 years after last session
											(educational and legal requirements)
										</li>
										<li>
											<strong>Safeguarding Records:</strong> Until 25th birthday or 7
											years, whichever is longer
										</li>
										<li>
											<strong>Financial Records:</strong> 6 years (HMRC requirements)
										</li>
										<li>
											<strong>Marketing Data:</strong> Until consent withdrawn or 3 years
											of inactivity
										</li>
										<li>
										...
										<li>
											<strong>CCTV Footage:</strong> 30 days (office premises only)
										</li>
									</ul>
								</div>
								...
								<ul>
									...
									<li>
										<strong>Right to Object:</strong> Stop processing for marketing or
								...
								<p>
									We will respond within one month and may request identification to
										...
										<div className='flex items-start gap-4'>
											...
											<div>
												...
												<p className='text-blue-800 text-lg leading-relaxed'>
													...
													children's data. We require parental consent for students under 13
													and maintain enhanced safeguarding procedures.
												</p>
											</div>
										</div>
									</Card>
								...
								<p>
									We take children's privacy seriously and comply with additional
									regulations:
								</p>
								<ul>
								...
								<p>
									If you have concerns about our data handling practices, please contact
									us first. If you remain unsatisfied, you can lodge a complaint with:
								</p>
								...
								<div className='bg-gray-50 p-6 rounded-lg my-6'>
									...
									<ul className='space-y-1 text-sm'>
										...
										<li>
											<strong>Address:</strong> Information Commissioner's Office, Wycliffe
								...
								<div className='bg-slate-100 p-6 rounded-lg my-6'>
									...
									<ul className='space-y-1 text-sm'>
										...
										<li>
											<strong>Post:</strong> Data Protection Officer, My Private Tutor
