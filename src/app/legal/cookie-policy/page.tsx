    ...
    <PageLayout background="white">
      ...
      <Section className="py-16">
        <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <ul className="mt-1 ml-4 space-y-1">
                  ...
                  <li>• Purpose: Remember language, theme, and display preferences</li>
                  <li>• Duration: 12 months</li>
                  <li>• Provider: My Private Tutor Online</li>
                </ul>
              </div>
          ...
          <ul>
            <li><strong>YouTube:</strong> Video embedding and analytics</li>
            <li><strong>Vimeo:</strong> Video hosting and playback</li>
            <li><strong>Zoom:</strong> Online tutoring session integration</li>
          </ul>

          <h3>3.2 Social Media</h3>
          <ul>
            <li><strong>Facebook:</strong> Social sharing and advertising</li>
            <li><strong>Twitter:</strong> Social sharing and engagement</li>
            <li><strong>LinkedIn:</strong> Professional networking and B2B marketing</li>
            <li><strong>Instagram:</strong> Visual content and engagement</li>
          </ul>
          ...
          <div className="bg-gray-50 p-6 rounded-lg my-6">
            ...
            <ul className="space-y-1 text-sm">
              <li><strong>Essential cookies:</strong> Session to 12 months</li>
              <li><strong>Functional cookies:</strong> 24 hours to 12 months</li>
              <li><strong>Analytics cookies:</strong> 24 hours to 2 years</li>
              <li><strong>Marketing cookies:</strong> 30 days to 3 months</li>
            </ul>
          </div>
          ...
          <p>
            Some cookies may contain personal data. This is processed in accordance with our 
          ...
          <p>
            Some third-party cookies may transfer data outside the UK/EEA. We ensure adequate 
            protection through:
          </p>
          <ul>
          ...
          <ul>
            <li><strong>Essential cookies:</strong> Legitimate interest (website functionality)</li>
          ...
          <div className="bg-slate-100 p-6 rounded-lg my-6">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><strong>Address:</strong> Data Protection Officer, My Private Tutor Online Limited, [Address]</li>
          ...
          <ul>
            <li><strong>ICO Cookie Guidance:</strong> <a href="https://ico.org.uk/for-organisations/guide-to-pecr/cookies-and-similar-technologies/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">ico.org.uk</a></li>
            <li><strong>All About Cookies:</strong> <a href="https://www.allaboutcookies.org/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">allaboutcookies.org</a></li>
            <li><strong>Your Online Choices:</strong> <a href="https://www.youronlinechoices.com/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">youronlinechoices.com</a></li>
            <li><strong>Google Privacy Controls:</strong> <a href="https://myaccount.google.com/data-and-privacy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">myaccount.google.com</a></li>
          </ul>
