...
function ServicesPageClient({
  ...
  const globalLocations: GlobalLocationData[] = [
    ...
    { country: "United States", students: 320, lat: 40.7128, lng: -74.006 },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
                Bespoke educational excellence for discerning families. Over 15
                years of proven results with royal endorsements.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-700 max-w-3xl mx-auto">
              ...
              each tailored to meet the exacting standards of discerning
              families.
            </p>
          </m.div>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-primary-600 mt-1">
                              Premium {service.title.toLowerCase()} education
                              services
                            </p>
                          </div>
                        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary-50 to-accent-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-700 max-w-3xl mx-auto">
              Our commitment to excellence has earned the trust of royal
              families and discerning clients worldwide.
            </p>
          </m.div>
