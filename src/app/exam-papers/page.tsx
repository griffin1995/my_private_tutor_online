...
const examCategories = [
	{
		...
		description:
			'Comprehensive collection of 11+ past papers from top independent schools',
		icon: <Target className='w-8 h-8 text-accent-600' />,
		papers: [
			{
				name: 'Eton College 11+ Mathematics',
				year: '2024',
				type: 'PDF',
				size: '2.3MB',
			},
			{
				name: 'Westminster Under School 11+ English',
				year: '2024',
				type: 'PDF',
				size: '1.8MB',
			},
			{
				name: "St Paul's Juniors 11+ Reasoning",
				year: '2024',
				type: 'PDF',
				size: '2.1MB',
			},
	...
	},
	{
		...
		papers: [
			{
				name: 'Edexcel GCSE Mathematics Paper 1',
				year: '2024',
				type: 'PDF',
				size: '1.9MB',
			},
			...
			{
				name: 'OCR GCSE Sciences Combined',
				year: '2024',
				type: 'PDF',
				size: '3.1MB',
			},
	...
	},
	{
		...
		description:
			'A-Level past papers and marking schemes for university preparation',
		...
		papers: [
			...
			{
				name: 'A-Level Chemistry Paper 2',
				year: '2024',
				type: 'PDF',
				size: '2.2MB',
			},
			{
				name: 'A-Level Physics Practical',
				year: '2024',
				type: 'PDF',
				size: '1.6MB',
			},
	...
	},
	{
		...
		papers: [
			{
				name: 'Oxford PAT Physics',
				year: '2024',
				type: 'PDF',
				size: '1.4MB',
			},
			{
				name: 'Cambridge STEP Mathematics',
				year: '2024',
				type: 'PDF',
				size: '2.8MB',
			},
			{
				name: 'BMAT Section 2 Scientific',
				year: '2024',
				type: 'PDF',
				size: '1.9MB',
			},
			...
			<PageHero
				...
				<div className='relative z-10 text-center space-y-6'>
					...
					<m.p
						...
						Access our comprehensive collection of past papers, marking schemes, and
						examination resources to enhance your preparation
					</m.p>
				</div>
			</PageHero>
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
						<div className='max-w-3xl mx-auto'>
							...
							<m.div
								...
								<Badge
									variant='secondary'
									className='hover:bg-accent-100 transition-colors duration-300'>
									11+ Entrance
								</Badge>
								<Badge
									variant='secondary'
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
						<div className='text-center mb-16'>
							...
							<p className='text-xl text-primary-700 max-w-3xl mx-auto'>
								Our curated collection of past papers and resources, organized by
								educational level for easy access
							</p>
						</div>
										...
										<CardContent>
											<div className='space-y-4'>
												{category.papers.map((paper, paperIndex) => (
													<div
														key={paperIndex}
														className='flex items-center justify-between p-4 bg-gradient-to-r from-white to-gray-50/50 rounded-lg hover:from-accent-50/30 hover:to-accent-50/10 transition-all duration-300 group'>
														...
														<Button
															variant='outline'
															size='sm'
															className='ml-4 group-hover:bg-accent-50 group-hover:border-accent-300 transition-all duration-300'>
												...
												<Button
													className='w-full mt-6 hover:bg-primary-50 transition-all duration-300'
													variant='outline'>
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
						<div className='max-w-5xl mx-auto text-center'>
							...
							<m.p
								...
								Our exam paper collection is exclusively available to current tutoring
								clients and their families. These resources are carefully curated to
								complement our tutoring programmes and provide targeted preparation for
								academic success.
							</m.p>
							...
							<div className='grid md:grid-cols-3 gap-8 mt-16'>
								<m.div
									...
									<h3 className='text-xl font-semibold text-primary-900 mb-3 group-hover:text-accent-700 transition-colors duration-300'>
										Updated Regularly
									</h3>
									<p className='text-primary-600 leading-relaxed'>
										Latest papers added as soon as they become available
									</p>
								</m.div>
								...
								<m.div
									...
									<p className='text-primary-600 leading-relaxed'>
										Complete marking schemes and examiner reports included
									</p>
								</m.div>
								...
								<m.div
									...
									<p className='text-primary-600 leading-relaxed'>
										Expert guidance on using papers effectively for preparation
									</p>
								</m.div>
							</div>
							...
							<m.div
								...
								<Button
									size='lg'
									className='px-12 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105'>
