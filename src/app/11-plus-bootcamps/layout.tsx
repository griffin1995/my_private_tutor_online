...
export const metadata: Metadata = {
  title: "11+ Bootcamps 2025 | Intensive Grammar School Preparation | Elite Tutoring",
  description: "Premium 11+ bootcamp preparation courses with expert tutors. 5-day intensive programs covering mathematics, English, verbal & non-verbal reasoning. Small group sizes, proven results for top grammar schools.",
  keywords: [
    "11+ bootcamps 2025",
  ...
  openGraph: {
    ...
    description: "Premium 5-day intensive 11+ preparation bootcamps with expert tutors. Small groups, comprehensive curriculum, proven success at top grammar schools.",
    images: [
      {
  ...
  twitter: {
    title: "11+ Bootcamps 2025 | Intensive Grammar School Preparation",
    description: "Premium intensive 11+ preparation courses. Expert tutors, small groups, comprehensive curriculum for grammar school success.",
