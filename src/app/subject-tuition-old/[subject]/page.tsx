	...
	try {
		...
		const PricingSection = () => (
			<div className='bg-white p-8 rounded-lg shadow-md'>
				...
				<p className='text-gray-600'>
					Pricing calculator will be dynamically loaded here
				</p>
			</div>
		);
		const BookingWidget = () => (
							...
							<div className='max-w-6xl mx-auto'>
								<div className='grid md:grid-cols-2 gap-12 items-center'>
									...
									<div className='bg-white rounded-xl shadow-lg p-8'>
										...
										<div className='space-y-4'>
											{subjectData.courseHighlights.map(
							...
							<div className='max-w-4xl mx-auto'>
								<div className='text-center mb-12'>
									...
									<p className='text-blue-100'>
										...
										{subjectData.displayName.toLowerCase()} tutors
									</p>
								</div>
								<BookingWidget />
							</div>
	...
	try {
		const subjectDatabase: Record<string, any> = {
			mathematics: {
				...
				description:
					'Master mathematics with our expert tutors. From basic arithmetic to advanced calculus, we provide comprehensive mathematical education.',
				heroDescription:
					'Unlock your mathematical potential with personalized tutoring from Oxbridge-educated experts. Build confidence and achieve excellence in mathematics.',
				benefits: [
			...
			english: {
				displayName: 'English',
				description:
					'Excel in English literature and language with our passionate and experienced English tutors.',
				heroDescription:
					'Develop exceptional English skills with our expert tutors. From creative writing to literary analysis, achieve your full potential.',
				benefits: [
			...
			science: {
				displayName: 'Science',
				description:
					'Discover the wonders of science with our qualified science tutors across all major scientific disciplines.',
				heroDescription:
					'Explore the fascinating world of science with expert guidance. Build strong foundations and develop critical thinking skills.',
				benefits: [
