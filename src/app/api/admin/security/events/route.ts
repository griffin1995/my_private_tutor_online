...
// Reference: /vercel/next.js secure API endpoints for admin

/**
 * Security events API endpoint for admin monitoring
 * Provides real-time security event data for dashboard
...
const mockSecurityEvents = [
  ...
  },
  {
    ...
    path: '/api/contact',
    details: { pattern: 'script tag detected' }
  }
]
