...
// API REASON: Real-time monitoring data access for royal client service dashboard
// CONTEXT7 SOURCE: /getsentry/sentry-docs - Performance monitoring API integration
// IMPLEMENTATION: Enterprise monitoring dashboard API endpoint
        ...
        return NextResponse.json(
          {
            ...
            availableTypes: ['dashboard', 'summary', 'alerts', 'system', 'performance', 'history'],
          },
          { status: 400 }
        );
    }
