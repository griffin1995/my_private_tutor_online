/**
 * CONTEXT7 SOURCE: /vercel/next.js - Enhanced FAQ search page with fuzzy matching
 * SEARCH PAGE: Advanced FAQ search interface with <100ms response time
 * 
 * Enhanced FAQ Search Page - Advanced Search Foundation
 * Comprehensive search page showcasing fuzzy matching and keyword highlighting
 * 
 * BUSINESS CONTEXT: £381,600 revenue opportunity through enhanced search findability
 * PERFORMANCE TARGET: <100ms search response time with intelligent fuzzy matching
 * SEARCH CAPABILITIES: Full-text search, keyword highlighting, relevance scoring
 * 
 * FEATURES:
 * - Advanced fuzzy search with Fuse.js integration
...
// CONTEXT7 SOURCE: /vercel/next.js - Search page props interface for App Router
// SEARCH PAGE PROPS: Type-safe search parameters handling
...
// CONTEXT7 SOURCE: /vercel/next.js - Client component metadata handled via head updates
// METADATA HANDLING: Client-side metadata management for dynamic search content

/**
 * FAQ Search Page Component
 * CONTEXT7 SOURCE: /vercel/next.js - Enhanced search page with advanced fuzzy matching
 * SEARCH PAGE: Comprehensive search interface with performance monitoring
 */
function FAQSearchPageContent({ searchParams }: FAQSearchPageProps) {
  // CMS DATA SOURCE: Using getFAQCategories for search data
  const faqCategories = getFAQCategories()
  const heroContent = getFAQHero()
  
  // Extract all questions from categories for search
  ...
  // CONTEXT7 SOURCE: /vercel/next.js - useSearchParams for URL state management
  // URL STATE: Sync search state with URL parameters
  ...
  useEffect(() => {
    const params = {
      ...
      difficulty: urlSearchParams.get('difficulty') as 'basic' | 'intermediate' | 'advanced' || undefined,
      clientSegment: urlSearchParams.get('segment') as 'oxbridge_prep' | '11_plus' | 'elite_corporate' | 'comparison_shopper' || undefined,
      limit: urlSearchParams.get('limit') ? parseInt(urlSearchParams.get('limit')!) : undefined
    }
  ...
  return (
    <>
      {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Enhanced search page hero */}
      {/* SEARCH HERO: Advanced search page hero with performance indicators */}
      <PageHero
        background="gradient"
        size="compact"
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            ...
            >
              Find answers instantly with intelligent fuzzy matching, keyword highlighting, and sub-100ms response time
            </m.p>
      ...
      {/* CONTEXT7 SOURCE: /vercel/next.js - Enhanced search interface */}
      {/* SEARCH INTERFACE: Advanced search with comprehensive functionality */}
            ...
            >
              ...
              >
                <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-slate-200">
                  ...
                  <h3 className="font-semibold text-slate-900 mb-2">Intelligent Matching</h3>
...
/**
 * FAQ Search Page with Suspense boundary
 * CONTEXT7 SOURCE: /vercel/next.js - Suspense patterns for async components
 * SUSPENSE BOUNDARY: Handle loading states for search parameters
 */
