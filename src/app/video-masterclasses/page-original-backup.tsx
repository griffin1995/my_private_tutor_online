/**
 * CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Revolutionary individual video showcase architecture
 * INDIVIDUAL SHOWCASE REASON: Official Tailwind CSS documentation patterns for unique positioning, NO CARDS WHATSOEVER
 * METALLIC BLUE DOMINANCE: Primary brand color (#3F4A7E) creating visual authority and trust throughout
 * AZTEC GOLD ACCENTS: Strategic luxury highlights (#CA9E5B) for premium positioning and sophisticated accents
 * 
 * REVOLUTIONARY ARCHITECTURE:
 * - NO CARD-BASED LAYOUTS - Each video gets unique individual treatment
 * - Six distinct showcase patterns: Cinematic Hero, Offset Testimonial, Spotlight, Intimate Story, Elegant Offset, Center Stage
 * - Sophisticated spacing system with architectural precision
 * - Complete elimination of repetitive patterns
 * - Metallic Blue primary with Aztec Gold strategic accents
 * 
 * INDIVIDUAL VIDEO TREATMENTS:
 * - CinematicHeroShowcase: Large hero placement with testimonial integration
 * - OffsetTestimonialShowcase: Asymmetric positioning with social proof
 * - FullwidthSpotlightShowcase: Theatrical full-screen presentation
 * - IntimateStoryShowcase: Personal narrative with warm connection
 * - ElegantOffsetShowcase: Luxury positioning with premium aesthetics
 * - CenterStageShowcase: Dramatic transformation-focused presentation
 */

"use client";

// CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Individual showcase component imports for revolutionary design
// REVOLUTIONARY IMPORT REASON: Official Tailwind CSS documentation supports unique component architectures
import { PageLayout } from "@/components/layout/page-layout";
import { SimpleHero } from "@/components/layout/simple-hero";
// CONTEXT7 SOURCE: /microsoft/typescript - Individual showcase components for NO-CARD architecture
// INDIVIDUAL SHOWCASE IMPORTS: Revolutionary video presentation system eliminating all card structures
import { 
  CinematicHeroShowcase,
  OffsetTestimonialShowcase, 
  FullwidthSpotlightShowcase,
  IntimateStoryShowcase,
  ElegantOffsetShowcase,
  CenterStageShowcase
} from "@/components/video-showcases";
import { getMasterclassVideo } from "@/lib/cms/cms-images";
import { Highlighter } from "@/components/magicui/highlighter";
import { m } from "framer-motion";
import { X, Star, Trophy, Users, BookOpen } from "lucide-react";
...
export default function VideoMasterclassesPage() {
  // CONTEXT7 SOURCE: /reactjs/react.dev - Revolutionary individual showcase state management
  // INDIVIDUAL SHOWCASE IMPLEMENTATION: Simplified state management for individual video presentations
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const videoRef = useRef<HTMLVideoElement>(null);

  // CONTEXT7 SOURCE: /reactjs/react.dev - Individual video handlers for showcase presentations
  // SHOWCASE CONTROL REASON: Official React documentation recommends individual component control
  ...
  // CONTEXT7 SOURCE: /reactjs/react.dev - Modal management for individual video showcases
  // MODAL ACCESSIBILITY: Keyboard handling for video modal interactions
  useEffect(() => {
  ...
  // CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Revolutionary individual showcase architecture patterns
  // INDIVIDUAL SHOWCASE REASON: Official Tailwind CSS documentation supports unique positioning for NO-CARD layouts
  return (
    <>
      {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Metallic Blue dominant hero with sophisticated positioning */}
      {/* REVOLUTIONARY HERO REASON: Official Tailwind CSS documentation patterns for brand color dominance */}
      <SimpleHero
      ...
      {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Revolutionary individual showcase layout system */}
      {/* NO-CARD ARCHITECTURE REASON: Official Tailwind CSS documentation supports sophisticated individual positioning systems */}
      {/* METALLIC BLUE DOMINANCE: Primary brand color (#3F4A7E) with Aztec Gold accents (#CA9E5B) throughout */}
