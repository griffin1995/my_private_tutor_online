...
const homeschoolingContent = {
	hero: {
		...
		description:
			'Comprehensive homeschooling programmes designed to provide expert educational support for families choosing to educate at home.',
	...
	programmes: {
		primary: {
			...
			description:
				'Foundation learning covering core subjects with creative and engaging approaches',
			subjects: [
		...
		secondary: {
			...
			description:
				'Comprehensive GCSE preparation and key stage 3 & 4 curriculum coverage',
			subjects: [
				'Core Mathematics',
				'English Language and Literature',
		...
		advanced: {
			...
			description:
				'A-Level and International Baccalaureate support for university preparation',
			subjects: [
	...
	support: {
		...
		description:
			'We provide extensive support for both students and parents throughout the homeschooling journey',
		features: [
			{
				title: 'Parent Training Workshops',
				description:
					'Monthly workshops to help parents understand curriculum requirements and teaching methodologies',
				icon: '👩‍🏫',
			},
			{
				title: 'Curriculum Planning',
				description:
					'Detailed curriculum plans aligned with national standards and university entrance requirements',
				icon: '📚',
			},
			{
				title: 'Progress Monitoring',
				description:
					'Regular assessments and detailed progress reports to track educational development',
				icon: '📊',
			},
			{
				title: 'Social Activities',
				description:
					'Organised social events and group activities to ensure healthy peer interaction',
				icon: '🤝',
			},
			{
				title: 'Technology Support',
				description:
					'Technical assistance with online learning platforms and educational software',
				icon: '💻',
			},
			{
				title: 'Examination Support',
				description:
					'Guidance through external examinations including GCSE, A-Level, and university entrance',
				icon: '🎯',
			},
		],
	},
		...
		<>
			...
			<section id='homeschooling-hero'>
				<PageHero
					...
					<GradientOverlay
						direction='br'
						className='from-emerald-800/30 via-transparent to-transparent'
					/>
					<div className='relative z-10 text-center space-y-8'>
						...
						<m.div
							...
							<Button
								size='lg'
								variant='secondary'
								className='bg-white text-emerald-700 hover:bg-white/90 shadow-lg hover:shadow-xl transition-all duration-300'>
								Start Your Journey
							</Button>
							<Button
								size='lg'
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
						<m.div
							...
							<p className='text-lg lg:text-xl text-slate-700 max-w-4xl mx-auto leading-relaxed'>
								Discover the advantages of home education with professional support and
								guidance from our expert tutors.
							</p>
						</m.div>
								...
								<m.div
									...
									<Card className='text-center h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] bg-white/90 backdrop-blur-sm group'>
										<CardContent className='p-8'>
											...
											<h3 className='text-xl font-semibold text-primary-900 mb-4 group-hover:text-emerald-700 transition-colors duration-300'>
												{benefit.title}
											</h3>
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8'>
						<m.div
							...
							<p className='text-lg text-slate-700 max-w-3xl mx-auto'>
								Comprehensive educational programmes designed for every stage of your
										...
										<CardContent className='space-y-6'>
											<div>
												...
												<div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
													{homeschoolingContent.programmes.primary.subjects.map(
														(subject, index) => (
															<div
																key={index}
											...
											<div>
												...
												<div className='flex flex-wrap gap-2'>
													{homeschoolingContent.programmes.primary.keyFeatures.map(
														(feature, index) => (
															<Badge
																key={index}
																variant='secondary'
									...
									<Card className='border-slate-200'>
										...
										<CardContent className='space-y-6'>
											<div>
												...
												<div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
													{homeschoolingContent.programmes.secondary.subjects.map(
														(subject, index) => (
															<div
																key={index}
																className='flex items-center gap-3'>
											...
											<div>
												...
												<div className='flex flex-wrap gap-2'>
													{homeschoolingContent.programmes.secondary.keyFeatures.map(
														(feature, index) => (
															<Badge
																key={index}
																variant='secondary'
										...
										<CardContent className='space-y-6'>
											<div>
												...
												<div className='grid grid-cols-1 gap-3'>
													{homeschoolingContent.programmes.advanced.subjects.map(
														(subject, index) => (
															<div
																key={index}
																className='flex items-center gap-3'>
											...
											<div>
												...
												<div className='flex flex-wrap gap-2'>
													{homeschoolingContent.programmes.advanced.keyFeatures.map(
														(feature, index) => (
															<Badge
																key={index}
																variant='secondary'
					...
					<div className='container mx-auto px-4 sm:px-6 lg:px-8'>
						<m.div
							...
							<p className='text-xl text-slate-300 mb-8 max-w-2xl mx-auto'>
								Book a free consultation to discuss your homeschooling needs and
								discover how we can support your family&apos;s educational goals.
							</p>
