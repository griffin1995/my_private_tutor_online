/**
 * CONTEXT7 SOURCE: /vercel/next.js - URL routing patterns for deep linking
 * DEEP LINKING REASON: Official Next.js documentation Section 6.3 recommends centralized URL pattern management
 * 
 * URL Pattern Definitions for Deep Linking
 * Supports iOS Universal Links, Android App Links, and PWA deep linking
 */

// CONTEXT7 SOURCE: /llfbandit/app_links - Deep linking URL pattern configuration
// URL PATTERN DESIGN: Comprehensive URL patterns for FAQ system deep linking functionality
...
// CONTEXT7 SOURCE: /llfbandit/app_links - FAQ-specific deep linking patterns for mobile app integration
// PATTERN STRUCTURE: Hierarchical URL patterns supporting all FAQ navigation scenarios
export const FAQ_DEEP_LINK_PATTERNS: Record<string, DeepLinkPattern> = {
  ...
  faq_search: {
    ...
    example: 'https://myprivatetutoronline.com/faq/search?q=oxbridge&category=academic',
    supports: ['ios', 'android', 'web', 'pwa'],
    priority: 2
  },
...
// CONTEXT7 SOURCE: /llfbandit/app_links - URL parameter extraction for deep link routing
// PARAMETER EXTRACTION: Parse URL parameters for FAQ deep linking navigation
...
// CONTEXT7 SOURCE: /vercel/next.js - URL pattern matching for deep link resolution
// PATTERN MATCHING: Identify deep link type and extract parameters from URL
...
// CONTEXT7 SOURCE: /vercel/next.js - Pattern matching utility for URL routing
// PATTERN MATCHING: Compare URL against defined patterns with parameter support
...
// CONTEXT7 SOURCE: /vercel/next.js - Parameter extraction from URL patterns
// PARAMETER EXTRACTION: Extract named parameters from URL based on pattern
function extractParams(
  ...
  if (searchParams.has('source')) {
    ...
    if (source && ['universal_link', 'app_link', 'pwa', 'web', 'share'].includes(source)) {
...
// CONTEXT7 SOURCE: /llfbandit/app_links - Deep link generation for cross-platform sharing
// LINK GENERATION: Create deep links for FAQ content sharing across platforms
export function generateDeepLink(
  ...
  const { baseUrl = 'https://myprivatetutoronline.com', includeSource = true, platform = 'web' } = options
  ...
  if (includeSource && platform) {
    searchParams.set('source', platform === 'ios' ? 'universal_link' : platform === 'android' ? 'app_link' : platform)
  }
...
// CONTEXT7 SOURCE: /llfbandit/app_links - Deep link validation for security and correctness
// VALIDATION: Ensure deep links are valid and safe for navigation
export function validateDeepLink(url: string): {
  ...
  try {
    ...
    if (!parseResult.isValid) {
      ...
      suggestions.push('Try using /faq, /faq/category/[category], or /faq/search?q=[query]')
    }
...
// CONTEXT7 SOURCE: /llfbandit/app_links - Platform detection for deep link handling
// PLATFORM DETECTION: Determine the platform and adjust deep link behavior accordingly
...
// CONTEXT7 SOURCE: /llfbandit/app_links - Deep link analytics tracking for performance monitoring
// ANALYTICS INTEGRATION: Track deep link usage for revenue opportunity analysis
  ...
  if (typeof window !== 'undefined' && (window as any).gtag) {
    (window as any).gtag('event', 'deep_link_accessed', {
      ...
      custom_parameters: {
        ...
        revenue_opportunity: 150, // £150 average per FAQ conversion
