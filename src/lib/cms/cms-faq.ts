...
function generateContentTags(
  ...
  switch (category) {
    case "service":
      if (content.includes("online") || content.includes("tutoring"))
        tags.push("online-tutoring");
      if (
        content.includes("oxbridge") ||
        content.includes("cambridge") ||
        content.includes("oxford")
      )
        tags.push("oxbridge");
      if (content.includes("elite") || content.includes("premium"))
        tags.push("premium-service");
      break;
    case "tutors":
      if (content.includes("examiner") || content.includes("tier"))
        tags.push("examiner-tutors");
      if (content.includes("qualified") || content.includes("teacher"))
        tags.push("qualified-teachers");
    ...
    case "subjects":
      if (
        ...
        tags.push("entrance-exams");
      if (content.includes("gcse") || content.includes("a-level"))
        tags.push("gcse-a-level");
      if (content.includes("university") || content.includes("admissions"))
        tags.push("university-prep");
      break;
    case "pricing":
      if (
        content.includes("£") ||
        ...
        tags.push("pricing-info");
      if (content.includes("discount") || content.includes("referral"))
        tags.push("discounts");
      break;
    case "scheduling":
      if (content.includes("book") || content.includes("schedule"))
        tags.push("booking-process");
      if (content.includes("cancel") || content.includes("reschedule"))
        tags.push("flexibility");
      break;
  }
  ...
  if (content.includes("parent") || content.includes("family"))
    tags.push("parents");
  if (content.includes("student") || content.includes("child"))
    tags.push("students");
 ...
 */
function determineClientSegment(
  question: string,
  answer: string
):
  | "oxbridge_prep"
  ...
  if (
    ...
    content.includes("cambridge") ||
    content.includes("oxford") ||
    content.includes("university admissions")
  ) {
  ...
  if (
    ...
    content.includes("entrance exam")
  ) {
    return "11_plus";
  }
  if (
    ...
    content.includes("bespoke") ||
    content.includes("tatler")
  ) {
...
function calculatePriorityScore(
  ...
  switch (category) {
    case "service":
      score += 2; // High priority for service overview
    case "pricing":
      score += 2; // High priority for pricing info
    case "scheduling":
      score += 1; // Medium priority for process questions
  }
  ...
  categories: [
    {
      ...
      description:
        "Learn about My Private Tutor Online's premium tutoring service, founded by Elizabeth Burrows in 2010.",
      icon: "Globe",
      color: "#0f172a",
      order: 1,
      isVisible: true,
      ...
      questions: [
        {
          ...
          tags: generateContentTags(
            "What is My Private Tutor Online?",
            "My Private Tutor Online is a boutique, specialist tutoring company founded in 2010...",
            "service"
          ),
          ...
          clientSegment: determineClientSegment(
            "What is My Private Tutor Online?",
            "My Private Tutor Online is a boutique, specialist tutoring company founded in 2010..."
          ),
          ...
          richMedia: [
            {
              ...
              description:
                "A brief introduction to our premium tutoring service",
              content: {
                type: "video" as const,
                id: "intro-video-1",
                ...
                accessibility: {
                  description:
                    "Elizabeth Burrows introduces My Private Tutor Online and explains our premium tutoring approach",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "Why do parents choose My Private Tutor Online?",
            "Personalised Experience: Our model is highly curated...",
            "service"
          ),
          priority: calculatePriorityScore(
            "Why do parents choose My Private Tutor Online?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Access to elite tutors from anywhere in the world...",
            "service"
          ),
          priority: calculatePriorityScore(
            "What are the benefits of online tutoring?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Our focus is online tutoring to maximise quality and match...",
            "service"
          ),
          priority: calculatePriorityScore(
            "Do you offer in-person tutoring?",
      ...
      subcategories: [
        {
          id: "overview",
          name: "Service Overview",
          description: "General information about our tutoring service",
          order: 1,
          questionCount: 2,
        },
        {
          id: "benefits",
          name: "Key Benefits",
          description: "Why families choose our premium service",
          order: 2,
          questionCount: 1,
        },
        {
          ...
          description: "Online and in-person tutoring options",
          order: 3,
          questionCount: 2,
        },
      ],
    },
    {
      ...
      description:
        "Learn about our three-tier tutor system and teaching approach, from official examiners to specialist graduates.",
      icon: "GraduationCap",
      color: "#7c3aed",
      order: 2,
      isVisible: true,
      ...
      questions: [
        {
          ...
          tags: generateContentTags(
            "How do the tutor tiers work?",
            "Tier 1: Super Tutors – official examiners or paper writers...",
            "tutors"
          ),
          priority: calculatePriorityScore(
            "How do the tutor tiers work?",
          ...
          richMedia: [
            {
              ...
              description:
                "Visual breakdown of our three-tier tutor system and qualifications",
              content: {
...
`,
                ...
                accessibility: {
                  description:
                    "Flowchart showing the three-tier tutor system at My Private Tutor Online with qualifications and pricing for each tier",
                  ariaLabel: "Tutor tier structure diagram",
                  longDescription:
                    "A hierarchical diagram showing Tier 1 Super Tutors (official examiners, £75-100/hour), Tier 2 Qualified Teachers (5+ years experience, £55-75/hour), and Tier 3 Graduate Specialists (subject specialists, £45-55/hour)",
                },
                configuration: {
                  width: "100%",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "Which tutor tier is right for me or my child?",
            "Tier 1 (Premium): Official examiners and senior subject leaders...",
            "tutors"
          ),
          priority: calculatePriorityScore(
            "Which tutor tier is right for me or my child?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "No problem. We'll quickly match you with another educator...",
            "tutors"
          ),
          priority: calculatePriorityScore(
            "What if I don't like my tutor?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "Do you have tutors for creative subjects too?",
            "Yes. We provide expert tutoring in subjects like Art, Drama, Music...",
            "tutors"
          ),
          priority: calculatePriorityScore(
            "Do you have tutors for creative subjects too?",
      ...
      subcategories: [
        {
          id: "structure",
          name: "Tutor Tiers",
          description: "Understanding our three-tier tutor system",
          order: 1,
          questionCount: 2,
        },
        {
          id: "selection",
          name: "Tutor Selection",
          description: "Choosing the right tutor for your needs",
          order: 2,
          questionCount: 1,
        },
        {
          id: "matching",
          name: "Tutor Matching",
          description: "Finding the perfect fit for your learning",
          order: 3,
          questionCount: 1,
        },
        {
          ...
          description: "Expertise across academic and creative subjects",
          order: 4,
          questionCount: 1,
        },
      ],
    },
    {
      ...
      description:
        "Comprehensive coverage of all major academic subjects, entrance exams, and international qualifications.",
      icon: "BookOpen",
      color: "#059669",
      order: 3,
      isVisible: true,
      ...
      questions: [
        {
          ...
          tags: generateContentTags(
            ...
            "We cover all major academic and entrance exam subjects...",
            "subjects"
          ),
          priority: calculatePriorityScore(
            "What subjects do you offer tutoring in?",
          ...
          richMedia: [
            {
              ...
              description:
                "A sample Python program demonstrating our programming tutoring approach",
              content: {
                type: "code" as const,
                id: "python-example-1",
...
if __name__ == "__main__":
    ...
    student.add_grade("Chemistry", 105)  # Invalid grade`,
                ...
                accessibility: {
                  description:
                    "Python code example showing object-oriented programming concepts taught in our Computer Science tutoring sessions",
            ...
            },
            {
              ...
              content: {
                ...
                accessibility: {
                  description:
                    "Interactive demonstration of quadratic equation solving with step-by-step visualization",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "Do you cover international exam boards and US college applications?",
            "Yes, we support students preparing for: IB, iGCSE, A Levels...",
            "subjects"
          ),
          priority: calculatePriorityScore(
            "Do you cover international exam boards and US college applications?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Yes. Our support includes: Personal statement coaching...",
            "subjects"
          ),
          priority: calculatePriorityScore(
            "Do you offer university admissions support?",
      ...
      subcategories: [
        {
          ...
          description: "Comprehensive range of academic subjects",
          order: 1,
          questionCount: 1,
        },
        {
          ...
          description: "IB, iGCSE, AP, and global exam boards",
          order: 2,
          questionCount: 1,
        },
        {
          ...
          description: "UCAS, Oxbridge, and admissions support",
          order: 3,
          questionCount: 1,
        },
      ],
    },
    {
      ...
      description:
        "Our track record of exceptional results, from 11+ success to Oxbridge placements and grade improvements.",
      icon: "TrendingUp",
      color: "#dc2626",
      order: 4,
      isVisible: true,
      ...
      questions: [
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Yes. We're proud to be featured in Tatler's Address Book...",
            "results"
          ),
          priority: calculatePriorityScore(
            "Do you have recommendations or testimonials?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "How do we know if tutoring is making a difference?",
            "Each tutor provides structured feedback, session summaries...",
            "results"
          ),
          priority: calculatePriorityScore(
            "How do we know if tutoring is making a difference?",
      ...
      subcategories: [
        {
          ...
          description: "Grade improvements and university placements",
          order: 1,
          questionCount: 1,
        },
        {
          ...
          description: "Verified feedback from parents and students",
          order: 2,
          questionCount: 1,
        },
        {
          ...
          description: "Tracking academic improvement and motivation",
          order: 3,
          questionCount: 1,
        },
      ],
    },
    {
      ...
      description:
        "Learn about our simple onboarding process, scheduling system, and how to track your tutoring progress.",
      icon: "Calendar",
      color: "#ea580c",
      order: 5,
      isVisible: true,
      ...
      questions: [
        {
          ...
          tags: generateContentTags(
            ...
            "We keep the onboarding process simple: 1. Complete our enquiry form...",
            "scheduling"
          ),
          priority: calculatePriorityScore(
            "How do I get started?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "Is there a way to track our tutoring schedule?",
            "Yes. You'll receive access to your personal client dashboard...",
            "scheduling"
          ),
          priority: calculatePriorityScore(
            "Is there a way to track our tutoring schedule?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            "How do we manage the schedule?",
            "Our admin team is always available to assist via email, phone and WhatsApp...",
            "scheduling"
          ),
          priority: calculatePriorityScore(
            "How do we manage the schedule?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Yes. While we don't offer free trials...",
            "scheduling"
          ),
          priority: calculatePriorityScore(
            "Can I try a tutor before committing?",
      ...
      subcategories: [
        {
          id: "onboarding",
          name: "Getting Started",
          description: "Simple steps to begin tutoring",
          order: 1,
          questionCount: 1,
        },
        {
          ...
          description: "Client dashboard and progress monitoring",
          order: 2,
          questionCount: 1,
        },
        {
          ...
          description: "Rescheduling and admin support",
          order: 3,
          questionCount: 1,
        },
        {
          id: "trial",
          name: "Trial Lessons",
          description: "Testing compatibility before commitment",
          order: 4,
          questionCount: 1,
        },
      ],
    },
    {
      ...
      description:
        "Complete three-tier pricing structure from £45-£85/hour, payment methods, discounts, and our no-registration-fee policy.",
      icon: "Banknote",
      color: "#ca8a04",
      order: 6,
      isVisible: true,
      ...
      questions: [
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "You'll receive itemised invoices to pay via secure bank transfer...",
            "pricing"
          ),
          priority: calculatePriorityScore(
            "How do we pay and when?",
        ...
        },
        {
          ...
          subcategory: "tracking",
          tags: generateContentTags(
            "Can I track payments and attendance?",
            "Yes. Your dashboard provides a transparent overview...",
            "pricing"
          ),
          priority: calculatePriorityScore(
            "Can I track payments and attendance?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Yes, discounts are available for: Block bookings...",
            "pricing"
          ),
          priority: calculatePriorityScore(
            "Do you offer discounts?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Absolutely. For each family you refer who books...",
            "pricing"
          ),
          priority: calculatePriorityScore(
            "Do you offer a referral scheme?",
      ...
      subcategories: [
        {
          ...
          name: "Hourly Rates",
          description:
            "Complete tier structure: Bronze £45/hr, Silver £65/hr, Gold £85/hr",
          order: 1,
          questionCount: 1,
        },
        {
          ...
          description: "Invoicing and credit balance system",
          order: 2,
          questionCount: 1,
        },
        {
          ...
          description: "Dashboard transparency for payments",
          order: 3,
          questionCount: 1,
        },
        {
          id: "discounts",
          name: "Discounts",
          description: "Block booking and sibling discounts",
          order: 4,
          questionCount: 1,
        },
        {
          ...
          description: "Free lesson credits for referrals",
          order: 5,
          questionCount: 1,
        },
      ],
    },
    {
      ...
      description:
        "Tutor verification, safeguarding policies, cancellation terms, and getting further support.",
      icon: "HelpCircle",
      color: "#6366f1",
      order: 7,
      isVisible: true,
      ...
      questions: [
        {
          ...
          tags: generateContentTags(
            "How are tutors selected and verified?",
            "All our tutors come from the highest academic backgrounds...",
            "other"
          ),
          priority: calculatePriorityScore(
            "How are tutors selected and verified?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Yes. Safeguarding is a top priority...",
            "other"
          ),
          priority: calculatePriorityScore(
            "Do you have a safeguarding policy?",
        ...
        },
        {
          ...
          tags: generateContentTags(
            ...
            "Lessons cancelled with more than 24 hours' notice...",
            "other"
          ),
          priority: calculatePriorityScore(
            "What is your cancellation policy?",
      ...
      subcategories: [
        {
          ...
          description: "DBS checks and recruitment process",
          order: 1,
          questionCount: 1,
        },
        {
          id: "safeguarding",
          name: "Safeguarding",
          description: "Child protection and safety policies",
          order: 2,
          questionCount: 1,
        },
        {
          id: "policies",
          name: "Policies",
          description: "Cancellation and termination terms",
          order: 3,
          questionCount: 1,
        },
        {
          id: "support",
          name: "Further Support",
          description: "Getting additional help and information",
          order: 4,
          questionCount: 1,
        },
      ],
...
export const searchFAQQuestions = (query: string): readonly FAQQuestion[] => {
  ...
  faqContent.categories.forEach((category) => {
    category.questions.forEach((question) => {
      ...
      const keywordMatch = question.searchKeywords.some((keyword) =>
...
export const getFAQQuestionsBySegment = (
  ...
  faqContent.categories.forEach((category) => {
    category.questions.forEach((question) => {
      if (
        question.clientSegment === segment ||
