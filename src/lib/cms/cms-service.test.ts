/**
 * CONTEXT7 SOURCE: /microsoft/typescript - TypeScript testing patterns and interfaces
 * CONTEXT7 SOURCE: /vercel/next.js - Server Components testing best practices
 * 
 * CMSService Test Suite - Comprehensive validation of unified CMS service
 * 
 * Test Categories:
 * - Singleton pattern validation
 * - Content retrieval with type safety
 * - Image access with fallbacks
...
describe('CMSService', () => {
  ...
  describe('Singleton Pattern', () => {
    ...
    it('should allow configuration on first initialization', () => {
      const config = {
        cache: { ttl: 10000, maxEntries: 50, enableDebug: true },
        development: { enableDebugLogging: true, logPerformanceMetrics: true }
      }
  ...
  describe('Validation and Error Handling', () => {
    ...
    it('should provide validation results for content', () => {
      const testContent = { title: 'Test', description: 'Test description' }
      const validation: ValidationResult<typeof testContent> = service.validateContent(testContent)
    ...
    it('should detect empty content objects', () => {
      ...
      expect(validation.isValid).toBe(true) // Empty objects are valid but warned
  ...
  describe('Performance Monitoring', () => {
    it('should record performance metrics when enabled', () => {
      ...
      const metrics: readonly PerformanceMetrics[] = service.getPerformanceMetrics()
      
      expect(Array.isArray(metrics)).toBe(true)
      // Note: Metrics might be empty if caching prevents new fetches
    })

    it('should clear performance metrics', () => {
      service.getSiteHeader() // Generate a metric
      service.clearPerformanceMetrics()
  ...
  describe('Utility Methods', () => {
    ...
    it('should generate srcset for responsive images', () => {
      const srcSet = service.generateSrcSet('/image.jpg', { small: 400, large: 800 })
  ...
  describe('Development Tools', () => {
    ...
    it('should allow configuration updates', () => {
      const newConfig = {
        cache: { ttl: 30000, maxEntries: 200, enableDebug: false },
        validation: { enableValidation: false, throwOnValidationError: false }
      }
  ...
  describe('Content Integration', () => {
    it('should retrieve all major content sections', () => {
      // Test major content retrieval doesn't throw
    ...
    it('should retrieve all major image assets', () => {
      // Test major image retrieval doesn't throw
...
describe('CMSService Integration', () => {
  ...
  it('should maintain backward compatibility with legacy functions', () => {
    // Import legacy functions to test compatibility
    const { getSiteHeader, getHeroContent, getMainLogo } = require('./cms-content')
