 ...
 * 
 * CONTEXT7 SOURCE: /microsoft/typescript - JSX syntax requires .tsx extension for TypeScript files
 * BUG FIX REASON: File renamed from .ts to .tsx per official TypeScript documentation Section 6.142 
 * which mandates .tsx extension for files containing JSX elements to enable proper compilation
 * 
 * CONTEXT7 SOURCE: /vercel/next.js - Dynamic import patterns for performance optimisation
 * IMPLEMENTATION REASON: Official Next.js lazy loading guide recommends next/dynamic for Client Components
 * with loading fallbacks and SSR configuration to reduce bundle size and improve LCP metrics
 * 
