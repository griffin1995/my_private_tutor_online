...
const FAQGamificationSystem = lazy(() => 
  import(/* webpackChunkName: "faq-gamification" */ '../faq/faq-gamification-system').then(mod => ({ 
    default: mod.FAQGamificationSystem 
  }))
)

const FAQAnalyticsDashboard = lazy(() => 
  import(/* webpackChunkName: "faq-analytics" */ '../analytics/faq-analytics-dashboard').then(mod => ({ 
...
const PerformanceDashboard = lazy(() => 
  import(/* webpackChunkName: "performance-dashboard" */ '../performance/PerformanceDashboard').then(mod => ({ 
...
const AdminDashboard = lazy(() => 
  import(/* webpackChunkName: "admin-dashboard" */ '../admin/faq-admin-dashboard').then(mod => ({
...
const QuoteRequestForm = lazy(() => 
  import(/* webpackChunkName: "quote-form" */ '../forms/quote-request-form').then(mod => ({ 
...
const NewsletterForm = lazy(() => 
  import(/* webpackChunkName: "newsletter" */ '../forms/newsletter-form').then(mod => ({ 
        ...
        <div className="container mx-auto px-4">
          <div className="animate-pulse">
            ...
            <div className="flex gap-4 overflow-hidden">
              {[1, 2, 3].map(i => (
                <div key={i} className="min-w-80 h-64 bg-slate-200 rounded-xl"></div>
              ))}
            </div>
          </div>
        </div>
...
const LazyCompetitiveAnalysis = dynamic(
  () => import(/* webpackChunkName: "competitive-analysis" */ '../sections/competitive-analysis').then(mod => ({ 
    default: mod.CompetitiveAnalysis || mod.default
  })).catch(() => Promise.resolve({ default: () => null })),
  {
    loading: () => <div className="h-96 bg-slate-100 animate-pulse rounded-xl"></div>,
    ssr: false
  }
)

const LazyCaseStudies = dynamic(
  () => import(/* webpackChunkName: "case-studies" */ '../sections/case-studies').then(mod => ({ 
...
const LazyIconCloud = dynamic(
  () => import(/* webpackChunkName: "icon-cloud" */ '../magicui/icon-cloud').then(mod => ({ 
    default: mod.IconCloud || mod.default
  })).catch(() => Promise.resolve({ default: () => null })),
  {
    loading: () => <div className="h-64 bg-slate-100 animate-pulse rounded-xl"></div>,
    ssr: false
  }
)

const LazyGlobe = dynamic(
  () => import(/* webpackChunkName: "globe" */ '../magicui/globe').then(mod => ({ 
...
export const LazyVoiceSearchComponents = (props: any) => (
  <Suspense fallback={<div className="h-16 bg-slate-100 rounded-lg animate-pulse"></div>}>
...
export const LazyQuoteRequestForm = (props: any) => (
  <Suspense fallback={<div className="h-96 bg-slate-100 animate-pulse rounded-xl"></div>}>
...
export const preloadGamificationSystem = () => 
  preloadComponent(() => import(/* webpackPrefetch: true */ '../faq/faq-gamification-system'))

export const preloadAnalyticsDashboard = () => 
  preloadComponent(() => import(/* webpackPrefetch: true */ '../analytics/faq-analytics-dashboard'))

export const preloadPerformanceDashboard = () => 
  preloadComponent(() => import(/* webpackPrefetch: true */ '../performance/PerformanceDashboard'))

export const preloadVoiceSearch = () => 
  preloadComponent(() => Promise.resolve({ default: () => null }))

export const preloadConsultationForm = () => 
  preloadComponent(() => import(/* webpackPrefetch: true */ '../forms/consultation-booking-form'))

export const preloadTestimonials = () => 
  preloadComponent(() => import(/* webpackPrefetch: true */ '../sections/testimonials-section'))
