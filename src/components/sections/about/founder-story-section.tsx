 ...
 * 
 * Founder Story Section Component - 6-Section Layout Implementation
 ...
 * Row 3: Going Against the Grain (Centered Text Container 50-70% width)
 * Row 4: Career Milestones (Centered Text Container with sub-sections)
 * Row 5: Global Experience (Full-Width Split 50/50)
 ...
 * 
 * Founder Story Section - 6-Row Layout Implementation
 * 
 * Implements the exact 6-section layout structure with optimal responsive design:
 ...
 * @returns JSX.Element - Rendered founder story section with 6-row layout
 */
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          >
            Our Founder Elizabeth did not follow the usual path into education. Her unconventional journey through six different schools, 
            across continents, and into the world of business journalism has shaped a unique approach to learning that puts choice, 
            confidence, and individual needs at the heart of everything we do.
          </m.p>
        </div>

        {/* ROW 2: Personal Introduction - Full-Width Split 50/50 */}
        {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - CSS Grid system for responsive layouts */}
        {/* SPLIT LAYOUT REASON: Official Tailwind CSS documentation Section 3.3 recommends grid classes for balanced content presentation */}
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="relative">
              {/* CONTEXT7 SOURCE: /vercel/next.js - Next.js Image component for founder portrait with performance optimisation */}
              {/* FOUNDER IMAGE REASON: Official Next.js documentation Section 3.4 recommends Image component for optimised loading */}
              <Image
          ...
          >
            ...
            <p className="text-lg text-primary-700 leading-relaxed">
              Considering how unconventional my own schooling was, perhaps it's no surprise that my approach to education is also 
              a little different. I moved through six different schools growing up, across private, state, faith, co-educational 
              and single-sex systems (including a boys' school run by monks — yes, really). My learning could have easily suffered, 
              especially since I have Dyspraxia, but one constant made a huge difference: my tutor. She not only gave me academic 
              consistency but something far more valuable — a quiet confidence and the belief that excellence was achievable, 
        ...
        {/* ROW 3: Going Against the Grain - Centered Text Container (50-70% width) */}
        {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Max-width utilities for optimal reading experience */}
        {/* CONTENT WIDTH REASON: Official Tailwind CSS documentation Section 4.2 recommends max-width for readability */}
        <m.div
          ...
          transition={fadeInUpVariant.transition}
        >
          <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary-900 mb-8 text-center">
            Going Against the Grain
          </h2>
          
          <div className="text-lg text-primary-700 leading-relaxed space-y-6">
            <p>
              By Sixth Form, I was achieving top grades. I hadn't planned to apply to Oxbridge, but when my headmistress pulled me 
              aside to ask if I'd considered it, something inside me switched on. I loved a challenge, and applying to Cambridge to 
              read English and Theatre with Education Studies was certainly that. But my offer letter was as much cause for agitation 
              as celebration.
            </p>
            
            <p>
              You see, I had already fallen in love with another course and city: Bristol. My elder sister was studying languages 
              there and although I had doggedly courted a Cambridge offer, I hadn't considered a world in which I would actually 
              receive one. What to do? Who turns down Cambridge? 17 year-old me.
            </p>
            
            <p>
              It was an agonising decision, but even then I knew it was the right one. Looking back, I realise that dilemma helped 
              define my ethos towards education: <strong>work as hard as you can to give yourself the luxury of choice, then have 
              the confidence to pick what's right for you — even if it's not what's expected.</strong>
            </p>
          </div>
        </m.div>
        ...
        >
          <div className="space-y-10">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-primary-700 leading-relaxed">
                I started tutoring at Bristol; it was love at first lesson. I've always had a natural affinity with children 
                and combining that with academics just made sense. I went on to complete my Masters, all the while refining my 
                tutoring practice, both in person and online. I quickly found myself being recommended from family to family.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-primary-700 leading-relaxed">
                What followed was a series of international placements and the opportunities to work with VIPs and private families 
                around the world. By 2017, I had visited all seven continents. I met and worked alongside some truly exceptional 
                educators — many of whom are still firm favourites in the tutoring team now.
              </p>
            </div>
          </div>
        </m.div>
        ...
        {/* ROW 5: Global Experience - Full-Width Split 50/50 */}
        {/* CONTEXT7 SOURCE: /tailwindlabs/tailwindcss.com - Grid system for balanced image and content layout */}
        {/* PROFESSIONAL IMAGE REASON: Official Tailwind CSS documentation Section 3.3 for responsive grid layouts */}
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <m.div
            initial={fadeInLeftVariant.initial}
            whileInView={fadeInLeftVariant.animate}
          ...
          >
            <div className="relative">
              {/* CONTEXT7 SOURCE: /vercel/next.js - Next.js Image component for professional Forbes image */}
              {/* PROFESSIONAL IMAGE REASON: Official Next.js documentation Section 3.4 for business credibility imagery */}
              <Image
          ...
          >
            ...
            <div className="text-lg text-primary-700 leading-relaxed space-y-4">
              <p>
                Keen to put my English degree to good use, during this time I also worked at Forbes Middle East as Online Editor. 
                I covered a range of subjects, including education.
              </p>
              
              <p>
                Conducting interviews with business moguls through Forbes reinforced that the right educational support doesn't just 
                help people ace exams — it shapes their choices, their confidence and their future. These leaders had turned their 
        ...
        >
          ...
          <div className="text-lg text-primary-700 leading-relaxed space-y-6 mb-8">
            <p>
              Since founding My Private Tutor Online more than 15 years ago, I've had the privilege of helping thousands of students 
              achieve their academic goals. What drives me isn't just the excellent grades (though we're proud of those), but the 
              transformation in confidence and self-belief that comes with truly understanding a subject.
            </p>
            ...
            <div className="bg-gradient-to-br from-accent-50 to-primary-50 p-8 rounded-3xl border border-accent-100">
              ...
              <p className="text-primary-700">
                Our approach works because we understand that every child learns differently, and we're not afraid to adapt our 
                methods to suit their unique needs and circumstances.
              </p>
            </div>
            
            <p>
              Education should open doors, not close them. It should build confidence, not crush it. Most importantly, it should 
              give young people the tools to make informed choices about their future — whatever that might look like.
            </p>
          </div>
