...
// CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog component import for professional video display
// HERO VIDEO DIALOG REASON: Official Magic UI patterns for full-screen modal video playback with portal rendering
...
export interface SubjectAccordionProps {
  ...
  // CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes need for onVideoClick prop
  // PROP REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog handles click events internally
}
...
interface AccordionSectionProps {
  ...
  isOpen: boolean
  onToggle: () => void
  // CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes need for onVideoClick prop in AccordionSectionProps
  // PROP REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog manages its own state and click handling
}
...
interface NestedSubjectItemProps {
  ...
  index: number
  parentId: string
  // CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes need for onVideoClick prop in NestedSubjectItemProps
  // PROP REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog components are self-contained
}
...
// CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes onVideoClick dependency from function parameters
// PARAMETER REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog components are self-contained and handle their own click events
      ...
      >
        ...
        {subjectItem.videoSection && (
          <div className="mb-6 relative">
            ...
            {/* CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog component for professional video display */}
            {/* HERO VIDEO DIALOG REASON: Official Magic UI patterns for full-screen modal video playback with optimized thumbnails and portal rendering */}
            <HeroVideoDialog
        ...
        {subjectItem.twoColumnVideoSection && (
          <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative">
              ...
              {/* CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog component for first video in two-column layout */}
              {/* TWO COLUMN VIDEO REASON: Official Magic UI patterns for professional dual video display with consistent portal rendering */}
              <HeroVideoDialog
            ...
            <div className="relative">
              ...
              {/* CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog component for second video in two-column layout */}
              {/* TWO COLUMN VIDEO REASON: Official Magic UI patterns for professional dual video display with consistent portal rendering */}
              <HeroVideoDialog
...
// CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes onVideoClick dependency from AccordionSection parameters
// PARAMETER REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog components manage their own state and click handling
...
export function SubjectAccordion({ 
  ...
  className = "",
  onSectionToggle
  // CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes onVideoClick prop dependency from main component
  // PROP REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog components are self-contained and handle their own click events
    ...
    <div className={`space-y-6 ${className}`}>
      {categories.map((category) => (
        <AccordionSection
          ...
          // CONTEXT7 SOURCE: /magicuidesign/magicui - HeroVideoDialog removes onVideoClick prop dependency
          // PROP REMOVAL REASON: Official Magic UI patterns - HeroVideoDialog components manage their own state internally
        />
      ))}
    </div>
  )
