// CONTEXT7 SOURCE: /testing-library/react-testing-library - Hero section testing patterns for conversion optimization
// TESTING REASON: Hero sections are critical for first impressions and conversion funnel performance
...
describe('PageHero', () => {
  describe('Basic Rendering', () => {
    ...
    it('applies default props correctly', () => {
      ...
      // Default background should be gradient
      expect(heroSection).toHaveClass('bg-gradient-to-br', 'from-white', 'via-primary-50', 'to-accent-50')
      
      // Default size should be lg
  ...
  describe('Background Variants', () => {
    ...
    it('renders image background variant with provided image', () => {
      render(
        <PageHero background="image" backgroundImage="/test-hero-image.jpg">
      ...
      expect(heroSection).toHaveStyle('background-image: url(/test-hero-image.jpg)')
    })

    it('renders video background variant with HTML5 video', () => {
      render(
        <PageHero background="video" backgroundVideo="/test-hero-video.mp4">
    ...
    it('includes video fallback sources and error message', () => {
      render(
        <PageHero background="video" backgroundVideo="/test-video.mp4">
          <h1>Video Hero</h1>
        </PageHero>
      )
    ...
    it('includes static fallback background for video', () => {
      ...
      const fallbackBg = document.querySelector('.bg-gradient-to-br.from-primary-900')
  ...
  describe('Size Variants', () => {
    ...
    it('renders full screen variant with proper layout breaking', () => {
      ...
      // Check negative margins for breaking out of PageLayout container
  ...
  describe('Overlay Features', () => {
    it('renders without overlay by default', () => {
      render(
        <PageHero background="image" backgroundImage="/test.jpg">
  ...
  describe('Content Layout', () => {
    ...
    it('maintains proper content visibility above backgrounds', () => {
      render(
        <PageHero background="video" backgroundVideo="/test.mp4">
      ...
      // Content should be above video background
  ...
  describe('Accessibility Features', () => {
    ...
    it('hides decorative elements from screen readers', () => {
      render(
        <PageHero background="video" backgroundVideo="/test.mp4" overlay={true}>
  ...
  describe('Performance Optimizations', () => {
    ...
    it('includes video optimization styles', () => {
      ...
      // Check for visual enhancement styles
      const computedStyle = window.getComputedStyle(video)
      expect(video).toHaveStyle('filter: brightness(0.75) contrast(1.1) saturate(1.1)')
    })
  })
  ...
  describe('Custom Styling', () => {
    ...
    it('combines custom classes with default classes', () => {
      render(
        <PageHero className="custom-class" size="sm" background="white">
  ...
  describe('Integration with Fixed Header', () => {
    it('uses proper full-screen sizing for fixed header overlay', () => {
      ...
      // Should not have top margin/padding that would create gaps
