/**
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG components with proper JSX patterns
 * IMPLEMENTATION REASON: Official React documentation for SVG element integration with JSX
 * 
 * FAQ SVG Icon Components - Centralized Icon Management
 * Features:
 * - Consistent 80x80 size for all icons
 * - Unified #343C54 color scheme  
 * - Proper React/JSX attribute naming (fillRule, clipRule)
 ...
 * - Consistent icon sizing for usability
 */

"use client"

// CONTEXT7 SOURCE: /facebook/react - React component interfaces for props typing
// INTERFACE REASON: TypeScript patterns for component prop definitions
import React from 'react'

/**
 * FAQ Icon Props Interface
 * CONTEXT7 SOURCE: /microsoft/typescript - Interface patterns for component props
 * PROPS STRUCTURE: Standard icon component interface with accessibility support
 */
...
/**
 * Globe Icon Component - Global/Worldwide Services
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents global reach and international tutoring services
 */
...
/**
 * Education Gap Icon Component - Education/Graduation Cap
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation  
 * VISUAL PURPOSE: Represents educational expertise and academic achievement
 */
...
/**
 * Book Open Icon Component - Open Book/Reading
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents curriculum content and educational materials
 */
...
/**
 * Trending Up Icon Component - Progress/Growth Chart
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents academic progress and measurable results
 */
...
/**
 * Calendar Icon Component - Scheduling/Time Management
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents scheduling flexibility and lesson management
 */
...
/**
 * Bank Note Icon Component - Payment/Pricing  
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents transparent pricing and payment information
 */
...
/**
 * Help Circle Icon Component - General Questions/Support
 * CONTEXT7 SOURCE: /facebook/react - Inline SVG JSX patterns from official React documentation
 * VISUAL PURPOSE: Represents general inquiries and additional support needs
 */
...
/**
 * FAQ Icon Map - Category ID to Component Mapping  
 * CONTEXT7 SOURCE: /microsoft/typescript - Record type patterns for object mapping
 * MAPPING PURPOSE: Centralized mapping between FAQ categories and their SVG icons
 */
...
/**
 * Get FAQ Icon Component by Category
 * CONTEXT7 SOURCE: /microsoft/typescript - Type-safe object property access patterns
 * UTILITY PURPOSE: Type-safe icon retrieval with fallback to help circle
 */
export const getFaqIconComponent = (categoryTitle: string): React.FC<FaqIconProps> => {
  // Convert category title to key format (lowercase, replace spaces with hyphens)
