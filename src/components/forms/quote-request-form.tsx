...
const AVAILABLE_SUBJECTS = [
	...
	{
		value: 'sciences',
		label: 'Sciences (Biology, Chemistry, Physics)',
	},
	{
		value: 'history',
		label: 'History',
	...
	},
	{
		...
		label: 'Modern Languages (French, German, Spanish)',
	},
	{
		value: 'classics',
		label: 'Classics (Latin, Greek)',
	},
	{
		value: 'economics',
		label: 'Economics',
...
export function QuoteRequestForm({
	...
	const handleSubjectToggle = (subjectValue: string) => {
		const updatedSubjects =
			selectedSubjects.includes(subjectValue) ?
		...
		return (
			<Card className={cn('w-full max-w-4xl mx-auto', className)}>
				<CardContent className='text-center py-12'>
					<div className='mb-6'>
						<CheckCircle
							className='h-16 w-16 text-accent-500 mx-auto mb-4'
							aria-hidden='true'
						/>
		...
		<Card className={cn('w-full max-w-4xl mx-auto', className)}>
			<CardHeader className={cn(compact ? 'pb-4' : 'pb-6')}>
				...
				<CardDescription className='leading-relaxed text-base'>
					Get a tailored quote for premium tutoring services. All enquiries are
					handled with complete discretion and confidentiality.
				</CardDescription>
			</CardHeader>
				...
				<form
									...
									render={({ field }) => (
										<Select
											...
											<SelectTrigger
												...
												aria-describedby={
													errors.studentAge ? 'studentAge-error' : undefined
												}>
						...
						<div className='space-y-6'>
							<div>
								<Label className='text-sm font-medium text-primary-800 mb-3 block'>
									Subjects Required *{' '}
									<span className='text-xs text-gray-500'>(Select up to 8)</span>
								</Label>
								<div
					...
					<section aria-labelledby='tutoring-preferences-heading'>
						<div className='flex items-center gap-2 mb-4'>
							...
							/>
							<h3
								id='tutoring-preferences-heading'
								className='text-lg font-semibold text-primary-800'>
									...
									render={({ field }) => (
										<Select
											...
											<SelectContent>
												...
												<SelectItem value='tatler-address-book'>
													Tatler Address Book
												</SelectItem>
												<SelectItem value='school-recommendation'>
													School Recommendation
												</SelectItem>
					...
					<div className='bg-gray-50 rounded-lg p-4 text-center'>
						...
						<p className='text-xs text-gray-600 leading-relaxed max-w-2xl mx-auto'>
							...
							We respect your privacy and maintain the highest standards of data
							protection. Your information will never be shared with third parties.
						</p>
					</div>
				</form>
			</CardContent>
