		...
		<Card className={cn('w-full max-w-2xl mx-auto', className)}>
			<CardHeader className={cn(compact ? 'pb-4' : 'pb-6')}>
				...
				<CardDescription className='leading-relaxed'>
					Begin your child's academic journey with a personalised consultation. All
				...
				<form
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
						<div>
							...
							<Select
								onValueChange={(value) =>
									setValue(
										'academicLevel',
										value as ConsultationFormData['academicLevel'],
									)
								}>
								<SelectTrigger
									className='mt-1'
						...
						<div>
							...
							<Select
								onValueChange={(value) =>
									setValue('urgency', value as ConsultationFormData['urgency'])
								}>
								<SelectTrigger
									className='mt-1'
									aria-label='Select timescale for tutoring support'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
						<div>
							...
							<Select
								onValueChange={(value) =>
									setValue(
										'preferredContact',
										value as ConsultationFormData['preferredContact'],
									)
								}>
								<SelectTrigger
									className='mt-1'
						...
						<div>
							...
							<Select
								...
								<SelectTrigger
									className='mt-1'
									aria-label='Select service level and budget'>
