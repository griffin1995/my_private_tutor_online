					...
					<div className='w-full mx-auto'>
						<Tabs.Root
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={PRIMARY_SCHOOL_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
							/>
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={SECONDARY_SCHOOL_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={ENTRANCE_EXAMS_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={UNIVERSITY_ADMISSIONS_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={ONLINE_HOMESCHOOLING_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
							...
							<TabContent
								...
								contentData={
									<EducationLevelTabContentSubjectTuition
										content={LONDON_IN_PERSON_CONTENT}
										testimonials={SUBJECT_TUITION_TESTIMONIALS}
										stats={SUBJECT_TUITION_STATS}
									/>
								}
