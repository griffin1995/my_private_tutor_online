...
async function removeDuplicates() {
  ...
  console.log('Removing identified duplicate assets for immediate performance gains\n');
...
async function generateCleanupReport(results, updatesApplied) {
  ...
  console.log(`Space Saved: ${Math.round(results.sizeSaved / 1024)}KB (${Math.round(results.sizeSaved / (1024 * 1024) * 100) / 100}MB)`);
...
async function main() {
  try {
    ...
    console.log('💡 Review application functionality and deploy optimized assets');
