...
test.describe('Performance Tests', () => {
  ...
  test('Images should be optimized and load efficiently', async ({ page }) => {
    ...
    const heroImages = imageMetrics.filter(img => 
      img.src.includes('hero') || img.loading === 'eager'
    )
  ...
  test('Page should handle slow network conditions gracefully', async ({ page, context }) => {
