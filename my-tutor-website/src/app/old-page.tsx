...
export default function Home() {
  ...
  const handleVideoPlay = () => {
    ...
    // Auto-play video when expanded with a longer delay for smooth animation
    setTimeout(() => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                <motion.div 
                  ...
                  initial={false}
                  animate={{
                    scale: isVideoExpanded ? 1.4 : 1,
                    opacity: isVideoExpanded || isLoaded ? 1 : 0,
                    x: isVideoExpanded ? 0 : (isLoaded ? 0 : 32),
                    y: isVideoExpanded ? 0 : 0,
                    zIndex: isVideoExpanded ? 50 : 1
                  }}
                  style={{
                    transformOrigin: 'center center'
                  }}
                ...
                <motion.div 
                  ...
                  initial={false}
                  animate={{
                    opacity: isVideoExpanded ? 0 : (isLoaded ? 1 : 0),
                    y: isVideoExpanded ? 20 : (isLoaded ? 0 : 32),
                    scale: isVideoExpanded ? 0.8 : 1
                  }}
                  transition={{ duration: 0.6, ease: "easeInOut" }}
                >
              ...
              >
                ...
                >
                  ...
                  <motion.div 
                    ...
                    initial={false}
                    animate={{
                      borderRadius: isVideoExpanded ? '12px' : '24px',
                      scale: isVideoExpanded ? 1.8 : 1,
                      boxShadow: isVideoExpanded 
                        ? '0 25px 50px -12px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(59, 130, 246, 0.4)'
