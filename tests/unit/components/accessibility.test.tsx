...
describe('Accessibility Utilities', () => {
  ...
  describe('Color Contrast', () => {
    test('getContrastRatio calculates contrast correctly', () => {
      ...
      const sameColors = getContrastRatio('rgb(128, 128, 128)', 'rgb(128, 128, 128)')
    ...
    test('meetsWCAGContrast correctly evaluates WCAG compliance', () => {
      ...
      expect(meetsWCAGContrast('rgb(0, 0, 0)', 'rgb(255, 255, 255)', 'AA')).toBe(true)
      
      // Light grey on white should not meet AA standards
      expect(meetsWCAGContrast('rgb(200, 200, 200)', 'rgb(255, 255, 255)', 'AA')).toBe(false)
      
      // Large text has lower contrast requirements
      expect(meetsWCAGContrast('rgb(150, 150, 150)', 'rgb(255, 255, 255)', 'AA', 'large')).toBe(true)
    })
  })
